...
export default function HomePage() {
  ...
  const [displayedMonth, setDisplayedMonth] = useState(getCurrentMonthStart);
  const currentMonthStart = getCurrentMonthStart();
  const isShowingCurrentMonth =
    displayedMonth.getFullYear() === currentMonthStart.getFullYear() &&
    displayedMonth.getMonth() === currentMonthStart.getMonth();
    ...
    <>
      ...
      >
        ...
        <div className="calendarToolbar">
          <div className="calendarToolbarGroup">
            <button
              type="button"
        ...
        <div className="calendarResetRow">
          <button
            type="button"
            className="calendarNavButton"
            onClick={() => setDisplayedMonth(getCurrentMonthStart())}
          ...
          <div className="supportCard">
            ...
            <div className="sponsorThanks" aria-labelledby="current-sponsors-title">
              ...
              <div className="sponsorLogoGrid">
                <a
                  className="sponsorLogoCard sponsorLogoCardBurns"
                  href="https://www.burnsmcd.com/"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Burns and McDonnell"
                >
                  <img
                    className="sponsorLogoImage sponsorLogoImageBurns"
                    src= "https://ik.imagekit.io/f9q7dtbaq/assets_optimized/branding/BurnsMcDonnell.png"
                ...
                <a
                  className="sponsorLogoCard sponsorLogoCardFaulhaber"
                  href="https://www.faulhaber.com/en/"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Faulhaber"
                >
                  <img
                    className="sponsorLogoImage sponsorLogoImageFaulhaber"
                    src= "https://ik.imagekit.io/f9q7dtbaq/assets_optimized/branding/Faulhaber.png"
                    alt="Faulhaber logo"
                    loading="lazy"
                    decoding="async"
                  />
